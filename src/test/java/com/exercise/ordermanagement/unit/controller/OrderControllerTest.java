...
public class OrderControllerTest {
    ...
    public void updateOrderWillReturnNotFoundIfServiceThrowException() throws Exception {
        ...
        doThrow(new OrderManagementException("Order not found")).when(orderService).takeOrder(orderId, request);
    ...
    public void getOrdersWillReturnBadRequestIfInvalidPageOrLimit() throws Exception {
        ...
        assertEquals("{\"error\":\"page and limit must be strictly positive\"}", new ObjectMapper().writeValueAsString(response.getBody()));
    }
